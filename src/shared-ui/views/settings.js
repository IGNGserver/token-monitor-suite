    ...
    <div class="settings-layout">
      <form class="panel settings-form" data-web-settings-form>
        ...
        <div class="form-grid">
          ...
          <label class="field field-wide"><span>${tr('settings.secret')}</span><input name="secret" type="password" autocomplete="off" spellcheck="false" value="${escapeHtml(appState().secret || '')}" /></label>
        </div>
