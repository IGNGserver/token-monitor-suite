...
(function exposeUsageCharts(root, factory) {
  ...
  const clientColors = {
    ...
    antigravity: '#4285f4', cline: '#323B43', kimi: '#16191e', grok: '#000000', copilot: '#000000', deepseek: '#4d6bfe', 'deepseek-harness': '#4d6bfe', cursor: '#000000', opencode: '#000000', openrouter: '#6566F1',
    openclaw: '#ff4d4d', xai: '#000000', meta: '#1d65c1', mistral: '#fa520f', qwen: '#615ced',
    pi: '#000', zed: '#4173e7', kilocode: '#F8F676', micode: '#000000', commandcode: '#4d8cff', zcode: '#000000', kiro: '#9046FF', codebuddy: '#6C4DFF', workbuddy: '#0DC8A5', proma: '#000000', qodercn: '#2ADB5C', reasonix: '#4d6bfe',
